...
namespace CoffeeApp.Core.Droid
    ...
    exception ReturnException0d4e750578a34b53ab1e98a7ef8efda8 of obj
    exception ReturnNoneException0d4e750578a34b53ab1e98a7ef8efda8
    [<AutoOpen>]
    module FuncConvertFinalOverload0d4e750578a34b53ab1e98a7ef8efda8 =
